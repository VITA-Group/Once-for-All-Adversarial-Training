...
def WRN40_2OAT(FiLM_in_channels=1, use2BN=False):
    return WideResNetOAT(depth=40, num_classes=10, widen_factor=2, dropRate=0.3, use2BN=use2BN, FiLM_in_channels=FiLM_in_channels)
